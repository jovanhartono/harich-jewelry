  ...
  return (
    <div className="container flex min-h-96 flex-col items-center gap-12 py-12 md:flex-row">
      <div className="flex flex-1 flex-col items-start justify-center">
        <h1 className={title()}>Oops. Your Cart is Empty</h1>
        <p className={subtitle()}>
          Don&apos;t miss out on the best deals! Your cart may be empty now, but
          let us help you fill it up with amazing products.
        </p>
        <Button
          as={Link}
          color="primary"
      ...
      <svg
        ...
        className="aspect-square flex-1 object-contain"
      >
        <path
