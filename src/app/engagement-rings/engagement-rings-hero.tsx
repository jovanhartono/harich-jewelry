...
import { getHeroImage } from "@/lib/shopify";
import { generateSrcSet } from "@/lib/utils";

export default async function EngagementRingsHero() {
  const { desktop_file, mobile_file } = await getHeroImage("engagement-rings");
